...
import (
	...
	"github.com/mugambocoin/mugambo-foundation/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/mugambocoin/mugambo-foundation/gossip/emitter External,TxPool,TxSigner,Signer
